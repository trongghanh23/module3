...
<div class=" row "style="background: #0dcaf0">
    ...
    <form>
        ...
        <div class="mb-3">
            <label for="disabledSelect" class="form-label">Choose type customer</label>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="TextInput" class="form-control" placeholder="birthday">
        </div>
        <div class="mb-3">
            <label for="disabledTextInput" class="form-label">gender</label>
            <input type="text" id="Input" class="form-control" placeholder="gender">
        </div>
        <div class="mb-3">
            <label for="disabledTextInput" class="form-label">id_card</label>
            <input type="text" id="text" class="form-control" placeholder="id_card">
        </div>
        <div class="mb-3">
            <label for="disabledTextInput" class="form-label">phone</label>
            <input type="text" id="t" class="form-control" placeholder="phone">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary ">
           <a style="color: cornsilk ; text-decoration: none" href="/view/customer/list.jsp">BACK</a>
        </button>
