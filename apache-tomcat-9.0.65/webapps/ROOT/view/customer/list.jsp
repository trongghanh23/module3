            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary">
                        <a href="/view/customer/edit.jsp" style="color: cornsilk; text-decoration: none">edit</a>

                    </button>
                <td>
                <td>
                    <button type="button" class="btn btn-primary">
                        <a href="/view/customer/add.jsp" style="color: cornsilk; text-decoration: none;">add</a>
